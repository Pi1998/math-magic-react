...
> Math Magicians is a modern, user-friendly calculator application built with React.js, designed to provide a seamless and efficient way for users to perform a wide range of mathematical calculations. Whether you're a student tackling homework, a professional solving complex equations, or anyone in need of quick calculations, Math Magicians is your go-to mathematical companion.
...
```sh
  ...
  git clone git@github.com/Pi1998/math-magic-react.git
  cd setup-react
